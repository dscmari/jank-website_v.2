    ...
    <div>
      ...
      <section className="flex flex-col 2xl:flex-row 2xl:items-center px-4 md:px-16 pt-8 lg:gap-12 lg:p-32 lg:py-32 2xl:gap-32 2xl:justify-center">
        <div className="flex-1 flex flex-col">
          <h1>
            Wir machen Deine Videos auf{" "}
            <span className="text-custom-red">YouTube sichtbar</span> : Damit Du
            die Nr. 1 wirst
          </h1>
          <p>
            YouTube unterscheidet sich von anderen Social Media Plattformen wie
            TikTok oder Instagram. Denn YouTube wird von Nutzern nicht nur zu
            Entertainment-Zwecken genutzt (Katzen Videos), sondern auch für
            relevante Informationsinhalte. Das bedeutet: Menschen suchen bei
            YouTube gezielt nach Themen, sowohl im privaten als auch im
            geschäftlichen Kontext.
          </p>
          <p className="py-4">
            Die meisten Menschen denken nicht sofort an YouTube, wenn sie an
            eine Suchmaschine denken. Und genau darin liegt die große Chance.
            Mit YouTube SEO kannst Du Deinen Kanal und Deine Videos auf der
            Videoplattform ganz nach oben bringen.
          </p>
          <p>
            Wir helfen Dir im YouTube SEO, damit Du sichtbarer wirst und mehr
            Neukunden gewinnst.
          </p>
          <a
        ...
        <div className="mt-24 lg:mt-12 xl:min-w-1/3">
          ...
          <p className="text-sm font-light p-8 max-w-xl mx-auto text-center">
            Mit YouTube SEO werden Deine Videos weit oben angezeigt. Damit Dich
            Deine Kunden finden
          </p>
        </div>
      </section>
      <section className="pt-24 lg:p-32 lg:pb-48 dark:xl:pb-64 relative lg:bg-custom-white dark:lg:py-0">
        ...
        <div className="lg:text-lg px-4 lg:px-0">
          <p>
            Wir kümmern uns um Deinen YouTube Account und veröffentlichen Deine
            Videos, damit sie die maximale Reichweite auf YouTube erzielen. Mit
            YouTube SEO werden Deine Videos in der YouTube-Suche ganz oben
            angezeigt.
          </p>
        </div>
      ...
      <section className="flex flex-col xl:flex-row gap-12 mt-24 lg:mt-0 lg:p-32 2xl:gap-32 2xl:justify-center dark dark:lg:mt-32">
        ...
        <div className="mx-4 lg:mx-0 2xl:max-w-1/2 3xl:max-w-1/3">
          <h1 className="text-center">
            ...
            <span className="text-custom-red">YouTube SEO Berater</span> aus
            Deutschland, Österreich, Südtirol & der Schweiz
          </h1>
          <InfoBtn
            content="YouTube SEO Experten"
          ...
          <div className="flex flex-col gap-4 mt-12">
            ...
            <p>
              Genau hier kommen unsere YouTube SEO Berater ins Spiel. Wir
              kümmern uns darum, dass Deine Videos perfekt hochgeladen werden.
              Mit gezielten Optimierungen bringen wir Dich in der YouTube Suche
              ganz nach vorne.
            </p>
            <p>
              Wer erstellt die Videos? Wir sind keine Videoproduzenten und
              kümmern uns ausschließlich um die Sichtbarkeit Deiner Videos. Wir
      ...
      <section className="mt-24 px-4 py-24 xl:m-0 xl:p-32 relative bg-custom-white dark:pt-0 dark:xl:pt-32">
        <div className="lg:max-w-2/3">
          <h1>
            Persönliche
            <span className="text-custom-red"> YouTube SEO Beratung</span> aus
            einer Hand
          </h1>
        </div>
        <div className="lg:text-lg">
          <p>
            ...
            Dich. Wir helfen Dir dabei, eine perfekte YouTube-Strategie zu
