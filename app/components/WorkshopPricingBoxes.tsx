...
type Props = {
  className?: string;
  pricingBoxes: WorkshopPricingBox[]
};

export default function WorkshopPricingBoxes({ className, pricingBoxes }: Props) {
  return (
        ...
        {pricingBoxes.map((e, index) => (
          ...
          >
            <div>
              ...
              <span className="font-semibold tracking-tight">Du lernst</span>
